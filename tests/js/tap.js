...
function run(check) {
    ...
    check("the pointer table reached the tests at all", rows.length, 15)
    ...
    check("every row lands in one of those three places",
          countWhere("listing") + countWhere("neighbour") + countWhere("rail"), rows.length)
